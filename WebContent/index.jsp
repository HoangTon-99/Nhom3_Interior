				...
				<div class="col-12 col-md-4 col-lg-3 mb-5 mb-md-0">
					<a class="product-item" href="${pageContext.request.contextPath}/view/cart.jsp"> <img
						...
						class="product-price">$50.00</strong> <span class="icon-cross">
							<img src="${pageContext.request.contextPath}/images/cross.svg"
							class="img-fluid">
					</span>
					</a>
				</div>
		...
		<div class="container">
			<div class="row justify-content-between">
				<div class="col-lg-6">
					...
					<div class="row my-5">
						<div class="col-6 col-md-6">
							<div class="feature">
								<div class="icon">
									<img src="${pageContext.request.contextPath}/images/truck.svg"
						...
						<div class="col-6 col-md-6">
							<div class="feature">
								<div class="icon">
									<img src="${pageContext.request.contextPath}/images/bag.svg"
										alt="Image" class="img-fluid">
								</div>
								<h3>Easy to Shop</h3>
								<p>Donec vitae odio quis nisl dapibus malesuada. Nullam ac
						...
						<div class="col-6 col-md-6">
							<div class="feature">
								<div class="icon">
									<img
										src="${pageContext.request.contextPath}/images/support.svg"
										alt="Image" class="img-fluid">
								</div>
								<h3>24/7 Support</h3>
								<p>Donec vitae odio quis nisl dapibus malesuada. Nullam ac
						...
						<div class="col-6 col-md-6">
							<div class="feature">
								<div class="icon">
									<img src="${pageContext.request.contextPath}/images/return.svg"
										alt="Image" class="img-fluid">
								</div>
				...
				<div class="col-lg-5 img-full">
					<div class="img-wrap ">
						<img
							src="${pageContext.request.contextPath}/images/why-choose-us-img.jpg"
							alt="Image" class="img-fluid">
					</div>
				</div>
				...
				<div class="col-lg-7 mb-5 mb-lg-0 img-full">
					<div class="imgs-grid">
						<div class="grid grid-1">
							<img
								src="${pageContext.request.contextPath}/images/img-grid-1.jpg"
								alt="Untree.co">
						</div>
						<div class="grid grid-2">
							<img
								src="${pageContext.request.contextPath}/images/img-grid-2.jpg"
								alt="Untree.co">
						</div>
						<div class="grid grid-3">
							<img
								src="${pageContext.request.contextPath}/images/img-grid-3.jpg"
								alt="Untree.co">
						</div>
					</div>
				</div>
