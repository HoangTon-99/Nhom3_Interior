	...
	<div class="why-choose-section">
		<div class="container">
			<div class="row justify-content-between align-items-center">
				...
				<div class="col-lg-5">
					<div class="img-wrap">
						<<img src="${pageContext.request.contextPath}/images/ghe.jpg"
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
					<img src="${pageContext.request.contextPath}/images/person_1.jpg"
				...
				<!-- Start Column 2 -->
				<div class="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
					<img src="${pageContext.request.contextPath}/images/person_2.jpg"
						class="img-fluid mb-5">
				...
				<!-- Start Column 3 -->
				<div class="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
					<img src="${pageContext.request.contextPath}/images/person_3.jpg"
						class="img-fluid mb-5">
					<h3 clas>
				...
				<!-- Start Column 4 -->
				<div class="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
					<img src="${pageContext.request.contextPath}/images/person_4.jpg"
						class="img-fluid mb-5">
